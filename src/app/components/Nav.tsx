...
<nav>
  <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <span className="self-center text-xs font-sans font-semibold whitespace-nowrap text-white">LegacyLine.</span>
    <button data-collapse-toggle="navbar-default" type="button" className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-transparent" aria-controls="navbar-default" aria-expanded="false">
